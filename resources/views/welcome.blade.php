...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('build/assets/app-DhXggnkR.css') }}">
    ...
    <thead>
        <tr>
            ...
            <th class="content-center ...">
                <input id="candidates" name="candidates" type="checkbox" class="size-6 content-center rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"></th>
                <th class="content-center ...">
                    <input id="candidates" name="candidates" type="checkbox" class="size-6 content-center rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"></th>
                    <th class="content-center ...">
                        <input id="candidates" name="candidates" type="checkbox" class="size-6 content-center rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"></th>
...
<form>
    <div class="space-y-12">
      <div class="border-b border-gray-300/10 pb-12">
        <h2 class="text-base/7 font-semibold text-gray-300">Personal Information</h2>
